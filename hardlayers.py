...
class ElementWiseMatMulLayer():
    ...
    def __init__(self, device, layer_id, save_folder=os.getcwd()):
        ...
        multiply - умножение 2 чисел (x, scale_x, sign_x, scale_w, sign_w, bl, wl)
        """
        self.device = device
    ...
    def find_weights_model(self, layer_weights, max_weight, print_flag=True):
        """
        Найти веса для слоя
